...
Cross-Cultural Service Quality - 5 組搜尋
"""
    ...
    searches = [
        {
            ...
            "max_results": 40,
            "description": "跨文化服務品質研究（2015-2024）",
        ...
        },
        {
            ...
            "max_results": 30,
            "description": "Hofstede文化維度理論應用（2010-2024）",
        ...
        },
        {
            ...
            "max_results": 30,
            "description": "文化差異與患者滿意度（2018-2024）",
        ...
        },
        {
            ...
            "max_results": 30,
            "description": "亞洲西方醫療比較（2015-2024）",
            "year_filter": "(2015-2024)"
        },
        {
            "id": "2.2-5",
            ...
            "max_results": 30,
            "description": "文化與以患者為中心照護（2018-2024）",
            "year_filter": "(2018-2024)"
        }
    ]
