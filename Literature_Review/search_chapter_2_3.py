#!/usr/bin/env python3
"""
Chapter 2.3 WOS Literature Search
Healthcare Systems Taiwan vs. USA - 5 組搜尋
"""
...
def main():
    print("\n" + "="*80)
    print("Chapter 2.3: Healthcare Systems Taiwan vs. USA")
    print("WOS 文獻搜尋 - 5 組搜尋，目標 160 篇")
    print("="*80 + "\n")
    ...
    searches = [
        {
            "id": "2.3-1",
            "query": "Taiwan AND National Health Insurance AND quality",
            "max_results": 40,
            "description": "台灣NHI研究（2018-2024）",
            "year_filter": "(2018-2024)"
        },
        {
            "id": "2.3-2",
            "query": "universal healthcare AND service quality",
            "max_results": 30,
            "description": "全民健保服務品質（2018-2024）",
            "year_filter": "(2018-2024)"
        },
        {
            "id": "2.3-3",
            "query": "healthcare system AND comparison AND (Asia OR Taiwan OR USA)",
            "max_results": 30,
            "description": "醫療體系比較（2015-2024）",
            "year_filter": "(2015-2024)"
        },
        {
            "id": "2.3-4",
            "query": "single-payer AND market-based AND healthcare",
            "max_results": 30,
            "description": "體系模式比較（2015-2024）",
            "year_filter": "(2015-2024)"
        },
        {
            "id": "2.3-5",
            "query": "Affordable Care Act AND quality",
            "max_results": 30,
            "description": "ACA對品質的影響（2015-2024）",
            "year_filter": "(2015-2024)"
        }
    ]
    ...
    try:
        ...
        for i, search in enumerate(searches, 1):
            print(f"\n{'='*80}")
            print(f"搜尋 {i}/5: {search['description']}")
