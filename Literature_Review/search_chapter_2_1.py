#!/usr/bin/env python3
"""
Chapter 2.1 WOS Literature Search
Healthcare Service Quality Foundations - 6 組搜尋
"""
...
def main():
    print("\n" + "="*80)
    print("Chapter 2.1: Healthcare Service Quality Foundations")
    print("WOS 文獻搜尋 - 6 組搜尋，目標 220 篇")
    print("="*80 + "\n")

    # 輸出目錄
    output_dir = "/Users/simon/Library/CloudStorage/Dropbox/paper/Working paper/Hospitals/LDA_hospital/Literature_Review/Chapter_2.1_Healthcare_Service_Quality"

    # 定義 6 組搜尋（修正查詢語法）
    searches = [
        {
            "id": "2.1-1",
            "query": "healthcare service quality",
            "max_results": 50,
            "description": "醫療服務品質基礎理論（2020-2024）",
            "year_filter": "(2020-2024)"
        },
        {
            "id": "2.1-2",
            "query": "SERVQUAL AND healthcare",
            "max_results": 40,
            "description": "SERVQUAL 在醫療的應用（2018-2024）",
            "year_filter": "(2018-2024)"
        },
        {
            "id": "2.1-3",
            "query": "patient experience AND service quality",
            "max_results": 40,
            "description": "患者體驗與服務品質（2020-2024）",
            "year_filter": "(2020-2024)"
        },
        {
            "id": "2.1-4",
            "query": "technical quality AND functional quality AND healthcare",
            "max_results": 30,
            "description": "Technical vs. Functional Quality（2015-2024）",
            "year_filter": "(2015-2024)"
        },
        {
            "id": "2.1-5",
            "query": "COVID-19 AND hospital AND service quality",
            "max_results": 30,
            "description": "COVID-19 對醫療服務品質的影響（2020-2024）",
            "year_filter": "(2020-2024)"
        },
        {
            "id": "2.1-6",
            "query": "patient satisfaction AND hospital",
            "max_results": 30,
            "description": "患者滿意度與品質維度（2018-2024）",
            "year_filter": "(2018-2024)"
        }
    ]
