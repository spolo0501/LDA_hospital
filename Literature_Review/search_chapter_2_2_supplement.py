...
"""
Chapter 2.2 補充搜尋
Cross-Cultural Service Quality - 3 組補充搜尋
"""
...
def main():
    print("\n" + "="*80)
    print("Chapter 2.2: Cross-Cultural Service Quality - 補充搜尋")
    print("WOS 文獻搜尋 - 3 組補充搜尋，目標 50 篇")
    print("="*80 + "\n")
    ...
    searches = [
        {
            "id": "2.2-S1",
            "query": "patient satisfaction AND (cross-cultural OR cultural differences)",
            "max_results": 20,
            "description": "患者滿意度跨文化比較（2015-2024）",
            "year_filter": "(2015-2024)"
        },
        {
            "id": "2.2-S2",
            "query": "Taiwan AND (healthcare quality OR hospital quality OR service quality)",
            "max_results": 15,
            "description": "台灣醫療服務品質研究（2015-2024）",
            "year_filter": "(2015-2024)"
        },
        {
            "id": "2.2-S3",
            "query": "SERVQUAL AND (cross-cultural OR international OR cultural)",
            "max_results": 15,
            "description": "SERVQUAL跨文化應用（2015-2024）",
            "year_filter": "(2015-2024)"
        }
    ]
    ...
    try:
        ...
        print("\n" + "="*80)
        print("✅ Session 獲取成功！開始執行 3 組補充搜尋...")
        print("="*80 + "\n")
        ...
        for i, search in enumerate(searches, 1):
            print(f"\n{'='*80}")
            print(f"補充搜尋 {i}/3: {search['description']}")
        ...
        print("\n📌 下一步：")
        print("  1. 合併原始 79 篇 + 補充文獻")
        print(f"  2. 預計總文獻數: 79 + {total_papers} = {79 + total_papers} 篇")
        print("  3. 去重後開始撰寫 Chapter 2.2")
